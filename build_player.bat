...
cl /nologo /EHsc /O2 /MT nr_player.cpp /link /OUT:nr_player.exe d3d12.lib dxgi.lib d3dcompiler.lib user32.lib gdi32.lib gdiplus.lib winmm.lib comctl32.lib comdlg32.lib shell32.lib dwmapi.lib uxtheme.lib
exit /b %errorlevel%
